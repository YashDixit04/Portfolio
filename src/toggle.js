const smMenuBtn = document.getElementsByClassName(
  "main-header__sm-scr-nav-btn"
);
const smMenu = document.getElementsByClassName("main-header__sm-menu");
const smMenuCloseBtn = document.getElementsByClassName(
  "main-header__sm-menu-close"
);

const smMenuLinks = document.querySelectorAll(".main-header__sm-menu-link");
const smMenuLink1 = document.getElementsByClassName(
  "main-header__sm-menu-link--1"
);
const smMenuLink2 = document.getElementsByClassName(
  "main-header__sm-menu-link--2"
);
const smMenuLink3 = document.getElementsByClassName(
  "main-header__sm-menu-link--3"
);
const smMenuLink4 = document.getElementsByClassName(
  "main-header__sm-menu-link--4"
);
...
// ---
const themeColorSelector = document.getElementsByClassName(".themeClrSelector");
const themeColorSelectorInput = document.getElementsByClassName(
...
// ---
const headerLogoConatiner = document.getElementsByClassName(
